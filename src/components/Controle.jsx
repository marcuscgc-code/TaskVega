...
export const Controle = () => {
    ...
    // Função para redirecionar para a tela de Criação
    const handleCriarProjeto = () => {
        navigate('/criacao'); // Redireciona para a tela de Criação
    };
                            ...
                            <div className="list-group">
                                ...
                                <div className="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <button
                                        ...
                                        onClick={handleCriarProjeto} // Adiciona o evento de clique
                                    >
                                        Ver 
